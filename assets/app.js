...
const themes = [
  ...
  { slug: 'fuye', name: '💰 副业搞钱专场', tagline: '聊副业怎么从 0 到 1 跑通', description: '围绕副业变现，聊自媒体、跨境等不同路径的真实经验。不聊割韭菜项目，聊普通人能落地的搞钱思路。', accentColor: '#B8860B', suitableFor: '在做或想做副业的人', hidden: true },
];
