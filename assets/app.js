...
const themes = [
  ...
  { slug: 'conf', name: '🎤 大型活动', tagline: '从沙龙走向百人舞台', description: '从 10-19 人的小范围沙龙，走向百人规模的行业大会。以协办方身份参与杭州创业者交流大会等大型活动，把 Coffee Chat 的连接带到更大的舞台。', accentColor: '#8C6D2F', suitableFor: '想在更大舞台上连接同频创业者的人' },
];
...
const faqConcept = [
  ...
  { q: '五大主题专场分别是什么？', a: '一人公司专场聚焦个人创业和一人商业模式；AI 专场聊 Agent 怎么落地到业务里；自媒体专场聊内容、聊人设、聊变现；副业搞钱专场聊普通人能落地的副业路径；大型活动则是从沙龙走向百人舞台的行业大会。每个主题都在持续迭代，围绕参与者真实关心的问题展开。' },
];
